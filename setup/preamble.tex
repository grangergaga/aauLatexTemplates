...
%% MY PACKAGES
%\graphicspath{ {figures/} } %relative path where to find figures
\usepackage{textcomp} %for degree Celsius with \textdegree command
\usepackage{color, soul} %for highlighting text with hl{} command
\usepackage{graphicx} %include figures
\usepackage{array} %for table arrangements
\usepackage{tabu} %for table alignments
\usepackage{ragged2e}
\usepackage{array}
\usepackage[strings]{underscore} %problem with doi in output.bbl, something with underscore not allowed (?)
\usepackage[version=4]{mhchem} %chemical reaction equations
\usepackage{multirow}
\usepackage{subcaption} %subfigures
%\usepackage{subfig} %subfigures
\usepackage{amsmath} %math equations aligned left
\usepackage[version=4]{mhchem}
\usepackage{chemformula} %better radical dot
\usepackage{siunitx}
\usepackage{pdfpages}
\usepackage{longtable} %tables over multiple pages
\usepackage{makecell} % cell line break
\usepackage{arydshln} % table dashed hline
%\usepackage{fourier}
\usepackage{xcolor,colortbl} %row color
\usepackage{lscape} %landscape mode, also for longtable
\usepackage{chngcntr} %for consecutive numbering
\usepackage{enumitem} % http://ctan.org/pkg/enumitem options such as [A], [B], ...
